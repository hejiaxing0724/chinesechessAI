...
AI.init = function(pace){
	...
	if (val&&val.value!=-8888) {
		...
		com.get("moveInfo").innerHTML='<h3>MiniMax Search Result</h3>Best Step:'+
										com.createMove(com.arr2Clone(play.map),man.x,man.y,val.x,val.y)+
										'<br />Depth:'+AI.treeDepth+'<br />Branch: '+
										AI.number+' <br />Evaluation:'+
										val.value+
										' <br />Time:'+
										(nowTime-initTime)+'msec'
